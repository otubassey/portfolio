...
import { Card, CardFooter, CardTextHeader } from "@/hwiui/widgets/card";
import { Chip } from "@/hwiui/widgets/chip";
import {OpenInNewIcon} from "@/hwiui/widgets/icon";
import {List, ListItemText} from "@/hwiui/widgets/list";
...
import Link from "@/hwiui/widgets/link/link";
...
const CompanyDetails = memo(displayName<CompanyDetailProps>("Experiences")(CompanyDetailComponent));
...
export default memo(displayName()(Experiences));
