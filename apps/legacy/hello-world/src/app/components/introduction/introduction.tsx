...
import {Characters} from "@/hwiui/widgets/typography";
    ...
    return (
        <>
            <Title aria-label={`I'm ${[FIRST_NAME, LAST_NAME].join(" ")}`} className="mb-6" variant="h1">
                ...
                <span className={ClassesUtils.concat(CLASSSNAMES.firstName, CLASSSNAMES.h1)}>
                    <Characters ref={firstNameCharacterRefs} text={FIRST_NAME} />
                </span>
                <span className={ClassesUtils.concat(CLASSSNAMES.lastName, CLASSSNAMES.h1)}>
            ...
            <Title
                ...
                className={ClassesUtils.concat(CLASSSNAMES.jobTitle, "mb-6")}
                variant="h3">
                {JOB_TITLE}
            </Title>
...
export default displayName()(Introduction);
