...
const Dialog = forwardRef<HTMLDivElement, Props>(({
    ...
    return (
        <div ref={ref} className={ClassesUtils.concat("min-h-dvh min-w-[36rem] bg-transparent transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0 h-screen", {["hidden"]: !open}, className)}>
...
Dialog.displayName = getDisplayName(Dialog);
