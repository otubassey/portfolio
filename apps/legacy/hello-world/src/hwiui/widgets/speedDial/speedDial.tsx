...
import { ClassesUtils, DeviceType, DeviceTypes } from "@/hwiutils";
...
function getPrimaryClassNames(deviceType: DeviceType, displaySecondaryIcons: boolean) {
    if(deviceType === DeviceTypes.MOBILE) {
        ...
        return ClassesUtils.concat(mobileClassNames.common, displaySecondaryIcons ? mobileClassNames.active : mobileClassNames.inactive);
    }
...
function getSecondaryClassName(deviceType: DeviceType, displaySecondaryIcons: boolean) {
    if(deviceType === DeviceTypes.MOBILE) {
        ...
        return ClassesUtils.concat(mobileClassNames.common, displaySecondaryIcons ? mobileClassNames.show : mobileClassNames.hide);
    }
...
const SpeedDial = forwardRef<HTMLDivElement, Props>(({
    children = null,
    className,
    deviceType,
    direction,
    ...
    return (
        <div ref={ref} className={ClassesUtils.concat(CLASSNAMES.root[primaryIconButtonPosition], className)}>
...
SpeedDial.displayName = getDisplayName(SpeedDial);
