...
const RestartAltIcon = forwardRef<SVGElement, SVGIconProps>(({
    description,
    title,
    ...otherProps
    ...
    return (
        <SVGBase
            ref={ref}
            description={description || "Restart Alt Icon"}
            title={title || "RestartAlt"}
            {...otherProps}>
                <g>
...
RestartAltIcon.displayName = getDisplayName(RestartAltIcon);
