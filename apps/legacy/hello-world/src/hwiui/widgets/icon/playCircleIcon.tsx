...
const PlayCircleIcon = forwardRef<SVGElement, SVGIconProps>(({
    description,
    title,
    ...otherProps
    ...
    return (
        <SVGBase
            ref={ref}
            description={description || "PlayCircle Icon"}
            title={title || "PlayCircle"}
            {...otherProps}>
            <g>
...
PlayCircleIcon.displayName = getDisplayName(PlayCircleIcon);
