...
const PsychologyIcon = forwardRef<SVGElement, SVGIconProps>(({
    description,
    title,
    ...otherProps
    ...
    return (
        <SVGBase
            ref={ref}
            description={description || "Psychology Icon"}
...
PsychologyIcon.displayName = getDisplayName(PsychologyIcon);

PsychologyIcon.propTypes = {
