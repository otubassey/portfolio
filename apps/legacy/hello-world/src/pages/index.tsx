...
import TestBed from "@/playground/app";
import { ConfigurationContext, ConfigurationContextProvider } from "@/hwiui/context/configuration";
import { displayName } from "@/hwiui/decorator";
import { ClassesUtils, DeviceTypes } from "@/hwiutils";
import { Section } from "@/hwiui/widgets/section";

import { Experiences } from "@/app/components/experiences";
import { Home } from "@/app/components/home";
import {Introduction} from "@/app/components/introduction";
import { LocateMeAt } from "@/app/components/locateMeAt";
import {NavigationFAB, NavigationList, NavigationLabel, useNavigation} from "@/app/components/navigation";
...
function mapSectionClassNames(active: boolean) {
  return {
    root: ClassesUtils.concat("block mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24", {["md:hidden"]: !active}),
    title: "text-2xl pb-5"
  };
}
...
function MainAppContainerComponent() {
  ...
  return (
    <div ref={setNavigationItemRef(NavigationLabel.HOME)} className={ClassesUtils.concat("theme-dark", CLASSNAMES.root, urbanist.className)}>
...
const MainAppContainer = displayName("Layout")(MainAppContainerComponent);

const DISPLAY_TEST_BED = true;

// function Layout({}) {
//   const [theme, setTheme] = useTheme();
//   console.log("tagged-Layout: theme =", theme);
...
export default displayName()(Layout);
