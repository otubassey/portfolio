...
* Updating the handling of routes
...
### Fixed
* Replacing HOF in api routes due to Vercel's production compiler expecting static, explicit function declarations
...
* Renaming from `helloworld-v1` to `helloworld-classic`
