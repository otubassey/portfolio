...
type OtuLabelAttributes = {
    group?: SVGGElement;
    path?: SVGPathElement;
};

type PixelPerfectLabelAttributes = {
    group?: SVGGElement;
    path?: SVGPathElement;
};

type OtuRoundedIconAttributes = SvgIconProps & {
    otuLabelProps?: OtuLabelAttributes;
    pixelPerfectLabelProps?: PixelPerfectLabelAttributes;
};

const OtuRoundedIcon = ({
    otuLabelProps,
    pixelPerfectLabelProps,
    ...svgIcon
}: OtuRoundedIconAttributes) => {
    const {group: otuLabelGroup, path: otuLabelPath} = otuLabelProps ?? {};
    const {fill: otuLabelGroupFill, transform: otuLabelTransform, ...otherOtuLabelGroup} = otuLabelGroup ?? {};
    const {d: otuLabelPathD, ...otherOtuLabelPath} = otuLabelPath ?? {};

    const {group: pixelPerfectLabelGroup, path: pixelPerfectLabelPath} = pixelPerfectLabelProps ?? {};
    const {fill: pixelPerfectLabelGroupFill, transform: pixelPerfectLabelTransform, ...otherPixelPerfectLabelGroup} = pixelPerfectLabelGroup ?? {};
    const {d: pixelPerfectLabelPathD, ...otherPixelPerfectLabelPath} = pixelPerfectLabelPath ?? {};
    return (
        <SvgIcon {...svgIcon}>
            <svg
                width="223.14805160370113"
                height="220.36875"
                viewBox="0 0 389.2227565622286 384.37499999999994">
                <defs>
                    <linearGradient id="SvgjsLinearGradient17130">
                        <stop stopColor="#905e26" offset="0"></stop>
                        <stop stopColor="#f5ec9b" offset="0.5"></stop>
                        <stop stopColor="#905e26" offset="1"></stop>
                    </linearGradient>
                    <linearGradient id="SvgjsLinearGradient17134">
                        <stop stopColor="#905e26" offset="0"></stop>
                        <stop stopColor="#f5ec9b" offset="0.5"></stop>
                        <stop stopColor="#905e26" offset="1"></stop>
                    </linearGradient>
                </defs>
                <g transform="matrix(3.605769798514529,0,0,3.605769798514529,-0.20032669795739863,0)" fill="#060606">
                    <g xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="10.5" cy="87.1" transform="rotate(-24.8 10.4 87.159)"></circle>
                        <path
                ...
                <g
                    transform="matrix(0.9333333333333332,0,0,0.9333333333333332,148.33333333333334,50.33333333333333)"
                    fill="url(#SvgjsLinearGradient17130)">
                    <path
                ...
                <g
                    transform="matrix(4.0564408284582205,0,0,4.0564408284582205,140.00976531370475,119.40795684089568)"
                    fill={otuLabelGroupFill ?? "url(#SvgjsLinearGradient17134)"}
                    {...otherOtuLabelGroup}>
                    <path
                ...
                <g
                    transform="matrix(0.9841929760702895,0,0,0.9841929760702895,112.01580702392971,294.99254706161105)"
                    fill={pixelPerfectLabelGroupFill ?? "#cbb26a"}
                    {...otherPixelPerfectLabelGroup}>
                    <path
...
export default memo(displayName()(OtuRoundedIcon));
