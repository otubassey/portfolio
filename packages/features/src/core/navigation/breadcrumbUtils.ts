...
import { Breadcrumb, BreadcrumbTree, GroupedBreadcrumbs } from "./types";
...
const fromBlueprint = (
	...
	return Object.freeze([current, ...children] as const);
};
...
const BreadcrumbUtils = Object.freeze({
	filterByParent,
	fromBlueprint,
	getFirstActive,
	getLastActive,
