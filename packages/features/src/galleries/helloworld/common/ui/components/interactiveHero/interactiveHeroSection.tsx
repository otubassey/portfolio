...
const INTERACTIVE_HERO_VIEWS = Object.freeze([
	{
...
function InteractiveHeroSection({
	...
	return (
		<Section
			...
			id={id}
			subheading="Visualizing the execution flow: Automated scripts and terminal simulations demonstrating syntax patterns across my tech stack."
			subheadingProps={HEADING_TYPOGRAPHY_PROPS}>
