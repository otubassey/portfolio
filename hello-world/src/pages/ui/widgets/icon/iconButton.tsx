...
function IconButton({
    ...
    return (
        <Component ref={ref} className={ClassesUtil.concat("group cursor-pointer rounded-full p-3 m-3 block hover:shadow-2xl hover:shadow-slate-500/50", className)} onClick={onClick} {...otherProps}>
            {
                Boolean(icon)
                    ? <IconComponent
...
export default forwardRef(withDisplayName()(IconButton));
